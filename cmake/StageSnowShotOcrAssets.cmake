...
if(NOT _model_count EQUAL 7)
    message(FATAL_ERROR
        "The checked-in OCR asset manifest must describe exactly 7 models.")
endif()
set(_small_model_index "")
math(EXPR _last_model_index "${_model_count} - 1")
foreach(_index RANGE 0 ${_last_model_index})
