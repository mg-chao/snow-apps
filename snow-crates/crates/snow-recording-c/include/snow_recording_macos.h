...
typedef enum SnowMacRecordingStatus {
    SNOW_MAC_RECORDING_OK = 0, SNOW_MAC_RECORDING_INVALID_ARGUMENT = 1,
    SNOW_MAC_RECORDING_PERMISSION_DENIED = 2, SNOW_MAC_RECORDING_TARGET_UNAVAILABLE = 3,
    SNOW_MAC_RECORDING_UNSUPPORTED = 4, SNOW_MAC_RECORDING_TIMEOUT = 5,
    SNOW_MAC_RECORDING_CANCELED = 6, SNOW_MAC_RECORDING_FAILED = 255
...
SnowMacRecordingStatus snow_recording_macos_microphone_permission_request(void (*completion)(uint8_t granted, void*), void* context);
...
SnowMacRecordingStatus snow_recording_macos_enumerate_inputs(void (*visitor)(const SnowMacInputDevice*, void*), void* context);
SnowMacRecordingStatus snow_recording_macos_create(const SnowMacRecordingConfig*, SnowMacRecording**);
SnowMacRecordingStatus snow_recording_macos_step(SnowMacRecording*, uint32_t timeout_ms, SnowMacRecordingEvent*);
