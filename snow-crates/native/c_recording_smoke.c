...
int main(void) {
    ...
    REQUIRE(snow_recording_macos_enumerate_inputs(NULL, NULL) ==
            SNOW_MAC_RECORDING_INVALID_ARGUMENT);
    REQUIRE(snow_recording_macos_microphone_permission_request(NULL, NULL) ==
            SNOW_MAC_RECORDING_INVALID_ARGUMENT);
