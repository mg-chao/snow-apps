...
<svg
  ...
  },
  {
    ...
    std::string_view(R"ADQT_SVG_81(<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="__ADQT_SLOT_PRIMARY__" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
)ADQT_SVG_81"), std::string_view("a63829e5ca0e9f94f046525bdf9b326532e7339f5c3fac1b9281b42eba3df404"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
    std::string_view("snow-shot"), std::string_view("outlined"), std::string_view("shape-ellipse"),
    std::string_view(R"ADQT_SVG_82(<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="__ADQT_SLOT_PRIMARY__" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  <circle cx="12" cy="12" r="9" stroke-width="1.5"/>
</svg>
)ADQT_SVG_82"), std::string_view("590ff1a5940fd9dc96cc227db93ebbdd907c383f058328745fef1e9e9631c004"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
    std::string_view("snow-shot"), std::string_view("outlined"), std::string_view("shape-rectangle"),
    std::string_view(R"ADQT_SVG_83(<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="__ADQT_SLOT_PRIMARY__" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  <rect x="4" y="4" width="16" height="16" rx="2" stroke-width="1.5"/>
</svg>
)ADQT_SVG_83"), std::string_view("a873dbff6a8c5f9399bb98da6fcae3ad666d4078c8550cdc7c6711e89d6cc635"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
    std::string_view("snow-shot"), std::string_view("outlined"), std::string_view("table-recognition"),
    std::string_view(R"ADQT_SVG_84(<?xml version="1.0" standalone="no"?><svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M870.4 65.1H153.6c-48.9 0-88.7 39.8-88.7 88.7v716.3c0 48.9 39.8 88.7 88.7 88.7h716.8c48.9 0 88.7-39.8 88.7-88.7V153.8c0-48.9-39.8-88.7-88.7-88.7zM416.4 416.4h191.2v191.2H416.4V416.4zM416.4 687.6h191.2v191.2H416.4V687.6zM144.9 416.4h191.5v191.2H144.9V416.4zM687.6 416.4h191.5v191.2H687.6V416.4zM153.6 145.1h716.8c4.8 0 8.7 3.9 8.7 8.7v182.6H144.9V153.8h8.7zM144.9 870.2V687.6h191.5v191.2H153.6c-4.8 0.1-8.7-3.8-8.7-8.6zM870.4 878.9H687.6V687.6h191.5v182.6c0-4.8 3.9-8.7 8.7 8.7z" fill="__ADQT_SLOT_PRIMARY__"/></svg>
)ADQT_SVG_84"), std::string_view("f51d6a824c35e745f95e83885e631adfdf16f5c3496fc602d53ad849812e88aa"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
    std::string_view("snow-shot"), std::string_view("outlined"), std::string_view("text-recognition"),
    std::string_view(R"ADQT_SVG_85(<?xml version="1.0" standalone="no"?><svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M668.65 64a85.333 85.333 0 0 1 60.353 25.003L892.33 252.33a85.333 85.333 0 0 1 25.002 60.352V832a128 128 0 0 1-128 128H234.667a128 128 0 0 1-128-128V192a128 128 0 0 1 128-128H668.65zM618.667 128h-384a64 64 0 0 0-64 64v640a64 64 0 0 0 64 64h554.666a64 64 0 0 0 64-64V362.667H682.667a64 64 0 0 1-64-64V128zM759.467 533.333c4.693 0 8.533 3.84 8.533 8.534V588.8a8.533 8.533 0 0 1-8.533 8.533H264.533A8.533 8.533 0 0 1 256 588.8v-46.933c0-4.694 3.84-8.534 8.533-8.534h494.934zM503.467 405.333c4.693 0 8.533 3.84 8.533 8.534V460.8a8.533 8.533 0 0 1-8.533 8.533H264.533A8.533 8.533 0 0 1 256 460.8v-46.933c0-4.694 3.84-8.534 8.533-8.534h238.934zM759.467 266.667H682.667V128l76.8 76.8v61.867z" fill="__ADQT_SLOT_PRIMARY__"/></svg>
)ADQT_SVG_85"), std::string_view("d44f4267cd1db8004c0a36ac57a8e25091e79ff8538c8243f7b810191056a8c9"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
    std::string_view("snow-shot"), std::string_view("outlined"), std::string_view("tool-arrow"),
    std::string_view(R"ADQT_SVG_86(<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
...
)ADQT_SVG_94"), std::string_view("90a4390c06f80c4043ca017c2f354ed1f0be5769d14ffaa02d57f0e60788ce14"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
...
)ADQT_SVG_100"), std::string_view("1a966953e23a5ad5d82836b2da95cbc66c28929c70daa396f7eb2cec7fcd0572"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
    std::string_view("snow-shot"), std::string_view("outlined"), std::string_view("watermark-gap"),
    std::string_view(R"ADQT_SVG_101(<?xml version="1.0" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><svg t="1785572334080" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="12789" xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="200"><path d="M33.450667 3.413333h102.4v956.8256H33.450667V3.413333z m887.330133 1.8432h102.4v957.713067h-102.4V5.188267z m-425.301333 200.704h108.9536l223.6416 584.977067h-102.4l-53.248-146.6368H427.485867l-53.248 146.6368h-102.4l223.6416-584.9088z m-39.3216 359.697067H643.754667L552.004267 309.248h-3.2768L456.157867 565.6576z" fill="__ADQT_SLOT_PRIMARY__" p-id="12790"></path></svg>
)ADQT_SVG_101"), std::string_view("71d5fc1aedd9b0f02a69018d9f7efb5c0d2eb4c0fac5dc58501ff97d42209310"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
    std::string_view("snow-shot"), std::string_view("outlined"), std::string_view("wheel-mouse"),
    std::string_view(R"ADQT_SVG_102(<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" fill="__ADQT_SLOT_PRIMARY__">
    <path
...
)ADQT_SVG_104"), std::string_view("d744264cf764d1add2b5caf7e65aa7b7006ab81ce8352804d8d7c0b566b6c55b"),
    IconColorModel::TwoTone, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view("#9254DE"), std::string_view("")}, false
  },
};

constexpr IconPack kStaticPack{std::string_view("snow-shot"), std::string_view("Snow Shot project-owned static SVG assets"), std::string_view("fdda516fed09777dfb0dc2728adf70720aaaed4395bd935f94b4427532ea61c0"), kEntries, sizeof(kEntries) / sizeof(kEntries[0])};
