...
)ADQT_SVG_75"), std::string_view("ab31ab4a39b923d4180309c2b196144dbac318c8ae1281395d0adca834d2e092"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
...
)ADQT_SVG_76"), std::string_view("744fac231a8e25a3d106bc46b1272d7e71ecd16872b8b928fc9f1d4f6222012f"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
...
)ADQT_SVG_77"), std::string_view("120452a6d1ae04fe7d3291f6b79aea1410d258088833b38190465efa1edc1cff"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
...
)ADQT_SVG_78"), std::string_view("a63829e5ca0e9f94f046525bdf9b326532e7339f5c3fac1b9281b42eba3df404"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
...
)ADQT_SVG_79"), std::string_view("590ff1a5940fd9dc96cc227db93ebbdd907c383f058328745fef1e9e9631c004"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
...
)ADQT_SVG_88"), std::string_view("a112f2b66023347e0d74182a1872b762b3707d0618242fb04549cbb3fbab6b13"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
...
)ADQT_SVG_91"), std::string_view("90a4390c06f80c4043ca017c2f354ed1f0be5769d14ffaa02d57f0e60788ce14"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
...
)ADQT_SVG_97"), std::string_view("1a966953e23a5ad5d82836b2da95cbc66c28929c70daa396f7eb2cec7fcd0572"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
    std::string_view("snow-shot"), std::string_view("outlined"), std::string_view("watermark-gap"),
    std::string_view(R"ADQT_SVG_98(<?xml version="1.0" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><svg t="1785572334080" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="12789" xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="200"><path d="M33.450667 3.413333h102.4v956.8256H33.450667V3.413333z m887.330133 1.8432h102.4v957.713067h-102.4V5.188267z m-425.301333 200.704h108.9536l223.6416 584.977067h-102.4l-53.248-146.6368H427.485867l-53.248 146.6368h-102.4l223.6416-584.9088z m-39.3216 359.697067H643.754667L552.004267 309.248h-3.2768L456.157867 565.6576z" fill="__ADQT_SLOT_PRIMARY__" p-id="12790"></path></svg>
)ADQT_SVG_98"), std::string_view("71d5fc1aedd9b0f02a69018d9f7efb5c0d2eb4c0fac5dc58501ff97d42209310"),
    IconColorModel::Monochrome, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view(""), std::string_view("")}, false
  },
  {
...
)ADQT_SVG_101"), std::string_view("d744264cf764d1add2b5caf7e65aa7b7006ab81ce8352804d8d7c0b566b6c55b"),
    IconColorModel::TwoTone, IconFit::Contain, IconStaticColors{std::string_view(""), std::string_view("#9254DE"), std::string_view("")}, false
  },
};

constexpr IconPack kStaticPack{std::string_view("snow-shot"), std::string_view("Snow Shot project-owned static SVG assets"), std::string_view("1f252fe548c29ee81eb54016f3329fe2cfc4284109bb6ffcda67380610777d56"), kEntries, sizeof(kEntries) / sizeof(kEntries[0])};
