...
StorageStatusSettingsWidget::StorageStatusSettingsWidget(
    ...
    m_diskUsageValue = createStatusValue(m_descriptions, QStringLiteral("disk-usage"));
    ...
    addStatusItem(m_descriptions, QStringLiteral("diskUsage"), m_diskUsageValue);
...
void StorageStatusSettingsWidget::applyTheme(
    ...
    const QVector<QLabel*> primaryLabels{m_entryCountValue, m_diskUsageValue, m_locationValue,
                                         m_modeValue};
    const QVector<QLabel*> valueLabels{m_entryCountValue, m_diskUsageValue, m_locationValue,
                                       m_modeValue, m_errorValue};
...
void StorageStatusSettingsWidget::retranslateUi() {
    m_descriptions->setItemLabel(m_descriptions->indexOf(QStringLiteral("entries")),
                                 tr("Entries"));
    m_descriptions->setItemLabel(m_descriptions->indexOf(QStringLiteral("diskUsage")),
                                 tr("Managed disk usage"));
    ...
    m_diskUsageValue->setAccessibleName(tr("Managed history disk usage"));
...
void StorageStatusSettingsWidget::syncStatus(
    ...
    m_diskUsageValue->setText(formattedBytes(status.historyUsage.totalBytes));
